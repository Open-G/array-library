...
<Project Type="Project" LVVersion="8208000">
   <Item Name="My Computer" Type="My Computer">
      ...
      <Item Name="build rules" Type="Folder">
         <Item Name="build.ogbld" Type="Document" URL="build rules/build.ogbld"/>
         <Item Name="package.ogpb" Type="Document" URL="build rules/package.ogpb"/>
      </Item>
      ...
      <Item Name="docs" Type="Folder">
         <Item Name="Meeting Notes" Type="Folder">
            <Item Name="2005-12-06 Meeting Notes.mmap" Type="Document" URL="docs/Meeting Notes/2005-12-06 Meeting Notes.mmap"/>
         </Item>
         <Item Name="ChangeLog-2.1.txt" Type="Document" URL="docs/ChangeLog-2.1.txt"/>
         <Item Name="ChangeLog-2.2.txt" Type="Document" URL="docs/ChangeLog-2.2.txt"/>
         <Item Name="ChangeLog-2.3.txt" Type="Document" URL="docs/ChangeLog-2.3.txt"/>
         <Item Name="ChangeLog-2.5.txt" Type="Document" URL="docs/ChangeLog-2.5.txt"/>
         <Item Name="ChangeLog-2.6.txt" Type="Document" URL="docs/ChangeLog-2.6.txt"/>
         <Item Name="ChangeLog-2.7.txt" Type="Document" URL="docs/ChangeLog-2.7.txt"/>
         <Item Name="ChangeLog-3.0.txt" Type="Document" URL="docs/ChangeLog-3.0.txt"/>
         <Item Name="ChangeLog-x.x.txt" Type="Document" URL="docs/ChangeLog-x.x.txt"/>
         <Item Name="Development Standards.txt" Type="Document" URL="docs/Development Standards.txt"/>
         <Item Name="History.txt" Type="Document" URL="docs/History.txt"/>
         <Item Name="Project File Organization.doc" Type="Document" URL="docs/Project File Organization.doc"/>
         <Item Name="ReleaseNotes-2.5.txt" Type="Document" URL="docs/ReleaseNotes-2.5.txt"/>
         <Item Name="ReleaseNotes-2.6.txt" Type="Document" URL="docs/ReleaseNotes-2.6.txt"/>
         <Item Name="ReleaseNotes-2.7.txt" Type="Document" URL="docs/ReleaseNotes-2.7.txt"/>
         <Item Name="ReleaseNotes-x.x.txt" Type="Document" URL="docs/ReleaseNotes-x.x.txt"/>
         <Item Name="Revision History.doc" Type="Document" URL="docs/Revision History.doc"/>
         <Item Name="ToDo.txt" Type="Document" URL="docs/ToDo.txt"/>
         <Item Name="MissingInTree.txt" Type="Document" URL="docs/MissingInTree.txt"/>
      </Item>
      <Item Name="examples" Type="Folder">
         <Item Name="Deferred Examples" Type="Folder">
            <Item Name="Append or Replace Array Element Example 01.vi" Type="VI" URL="examples/Deferred Examples/Append or Replace Array Element Example 01.vi"/>
            <Item Name="Initialize Array from Array Example 01.vi" Type="VI" URL="examples/Deferred Examples/Initialize Array from Array Example 01.vi"/>
         </Item>
         <Item Name="Conditional Auto-Indexing Tunnel Example 01.vi" Type="VI" URL="examples/Conditional Auto-Indexing Tunnel Example 01.vi"/>
         <Item Name="Filter 1D Array Example 01.vi" Type="VI" URL="examples/Filter 1D Array Example 01.vi"/>
         <Item Name="Index Array Elements (1D) Example 01.vi" Type="VI" URL="examples/Index Array Elements (1D) Example 01.vi"/>
         <Item Name="Index Array Elements (2D) Example 01.vi" Type="VI" URL="examples/Index Array Elements (2D) Example 01.vi"/>
      ...
      <Item Name="source" Type="Folder">
         <Item Name="help" Type="Folder">
            <Item Name="OpenG_Array_Tools_Icon.png" Type="Document" URL="source/help/OpenG_Array_Tools_Icon.png"/>
         ...
         <Item Name="library" Type="Folder">
            ...
            <Item Name="Initialize Array from Array" Type="Folder">
               ...
               <Item Name="Initialize 1D Array (Boolean) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Boolean) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (Boolean) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Boolean) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (Boolean) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Boolean) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (Boolean) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Boolean) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (CDB) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CDB) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (CDB) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CDB) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (CDB) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CDB) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (CDB) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CDB) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (CSG) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CSG) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (CSG) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CSG) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (CSG) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CSG) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (CSG) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CSG) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (CXT) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CXT) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (CXT) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CXT) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (CXT) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CXT) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (CXT) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (CXT) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (DBL) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (DBL) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (DBL) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (DBL) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (DBL) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (DBL) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (DBL) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (DBL) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (EXT) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (EXT) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (EXT) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (EXT) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (EXT) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (EXT) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (EXT) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (EXT) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (I16) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (I16) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (I16) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (I16) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (I16) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (I16) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (I16) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (I16) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (I32) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (I32) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (I32) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (I32) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (I32) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (I32) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (I32) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (I32) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (I8) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (I8) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (I8) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (I8) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (Path) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (DBL).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (EXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (EXT).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (I16).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (I16).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (I32).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (I32).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (I8).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (I8).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (Path).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (Path).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (SGL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (SGL).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (String).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (String).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (U16).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (U16).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (U32).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (U32).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (U8).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (U8).vi"/>
               <Item Name="Initialize 1D Array (Path) from 1D Array (Variant).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Path) from 1D Array (Variant).vi"/>
               <Item Name="Initialize 1D Array (SGL) from 1D Array (Boolean).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (SGL) from 1D Array (Boolean).vi"/>
               <Item Name="Initialize 1D Array (SGL) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (SGL) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (SGL) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (SGL) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (SGL) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (SGL) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (SGL) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (SGL) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (String) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (DBL).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (EXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (EXT).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (I16).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (I16).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (I32).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (I32).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (I8).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (I8).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (Path).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (Path).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (SGL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (SGL).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (String).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (String).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (U16).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (U16).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (U32).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (U32).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (U8).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (U8).vi"/>
               <Item Name="Initialize 1D Array (String) from 1D Array (Variant).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (String) from 1D Array (Variant).vi"/>
               <Item Name="Initialize 1D Array (U16) from 1D Array (Boolean).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (U16) from 1D Array (Boolean).vi"/>
               <Item Name="Initialize 1D Array (U16) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (U16) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (U16) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (U16) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (U16) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (U16) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (U16) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (U16) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (U32) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (U32) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (U32) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (U32) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (U32) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (U32) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (U32) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (U32) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (U8) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (U8) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (U8) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (U8) from 1D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 1D Array (Variant) from 1D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (CDB).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (CSG).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (CXT).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (DBL).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (EXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (EXT).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (I16).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (I16).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (I32).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (I32).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (I8).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (I8).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (Path).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (Path).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (SGL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (SGL).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (String).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (String).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (U16).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (U16).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (U32).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (U32).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (U8).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (U8).vi"/>
               <Item Name="Initialize 1D Array (Variant) from 1D Array (Variant).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 1D Array (Variant) from 1D Array (Variant).vi"/>
               <Item Name="Initialize 2D Array (Boolean) from 2D Array (Boolean).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Boolean) from 2D Array (Boolean).vi"/>
               <Item Name="Initialize 2D Array (Boolean) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Boolean) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (Boolean) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Boolean) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (Boolean) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Boolean) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (Boolean) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Boolean) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (CDB) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CDB) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (CDB) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CDB) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (CDB) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CDB) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (CDB) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CDB) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (CSG) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CSG) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (CSG) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CSG) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (CSG) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CSG) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (CSG) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CSG) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (CXT) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CXT) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (CXT) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CXT) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (CXT) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CXT) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (CXT) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (CXT) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (DBL) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (DBL) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (DBL) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (DBL) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (DBL) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (DBL) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (DBL) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (DBL) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (EXT) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (EXT) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (EXT) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (EXT) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (EXT) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (EXT) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (EXT) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (EXT) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (I16) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (I16) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (I16) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (I16) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (I16) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (I16) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (I16) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (I16) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (I32) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (I32) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (I32) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (I32) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (I32) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (I32) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (I32) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (I32) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (I8) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (I8) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (I8) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (I8) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (Path) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Path) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (Path) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Path) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (Path) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Path) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (Path) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Path) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (SGL) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (SGL) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (SGL) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (SGL) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (SGL) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (SGL) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (SGL) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (SGL) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (String) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (String) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (String) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (String) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (String) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (String) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (String) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (String) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (U16) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (U16) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (U16) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (U16) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (U16) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (U16) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (U16) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (U16) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (U32) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (U32) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (U32) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (U32) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (U32) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (U32) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (U32) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (U32) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (U8) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (U8) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (U8) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (U8) from 2D Array (DBL).vi"/>
               ...
               <Item Name="Initialize 2D Array (Variant) from 2D Array (CDB).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Variant) from 2D Array (CDB).vi"/>
               <Item Name="Initialize 2D Array (Variant) from 2D Array (CSG).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Variant) from 2D Array (CSG).vi"/>
               <Item Name="Initialize 2D Array (Variant) from 2D Array (CXT).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Variant) from 2D Array (CXT).vi"/>
               <Item Name="Initialize 2D Array (Variant) from 2D Array (DBL).vi" Type="VI" URL="source/library/Initialize Array from Array/Initialize 2D Array (Variant) from 2D Array (DBL).vi"/>
      ...
      <Item Name="source 7.x" Type="Folder">
      ...
      <Item Name="tests" Type="Folder">
         ...
         <Item Name="TEST - Append or Replace Array Element - Inputs.ctl" Type="VI" URL="tests/TEST - Append or Replace Array Element - Inputs.ctl"/>
         <Item Name="TEST - Append or Replace Array Element - Outputs.ctl" Type="VI" URL="tests/TEST - Append or Replace Array Element - Outputs.ctl"/>
         <Item Name="TEST - Append or Replace Array Element.vi" Type="VI" URL="tests/TEST - Append or Replace Array Element.vi"/>
